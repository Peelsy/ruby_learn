...
item1 = VirtualItem.new({:real_price => 101, :weight => 100, :name => "car"})
item2 = RealItem.new({ :real_price => 105, :weight => 100, :name => "car"})
item3 = RealItem.new({ :real_price => 105, :weight => 100, :name => "computer"})
